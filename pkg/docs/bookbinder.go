...
title: {{.Title}}
owner: {{.Owner}}
warning: This file is auto-generated by github.com/pivotal/indicator-protocol. Any changes will likely be overwritten. Edit the associated indicators yaml file to make changes.
---
